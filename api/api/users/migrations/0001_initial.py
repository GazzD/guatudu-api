    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message='Phone nubmer must be entered in the formar: +999999999. Up to 15 digits allowed.', regex='\\+?1?\\d{9,15}$')])),
                ('is_client', models.BooleanField(default=True, help_text='Hlelp easily distinguish uysers and perform queries.Clients are the main type user.', verbose_name='client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reputation', models.FloatField(default=5.0, help_text="Users's reputation based on the ides taken and offered")),
