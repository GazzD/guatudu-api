...
from api.guatudu.views.profiles import users as user_profile_views
...
router.register(r'profiles/users', user_profile_views.UserProfileViewSet, basename='profiles/user')
