    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_profiles', models.ManyToManyField(to='guatudu.AdminProfile')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Date time on witch the object was created', verbose_name='created_at')),
                ('modified', models.DateTimeField(auto_now=True, help_text='Date time on witch the object was last modified', verbose_name='modified_at')),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guatudu.AdminProfile')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guatudu.Business')),
            ],
            options={
                'ordering': ['-created', '-modified'],
                'get_latest_by': 'created',
